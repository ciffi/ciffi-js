...
var Dev = (function () {
    ...
    function Dev() {
        ...
        if (fileExists(process.env.PWD + '/src/scripts/config/env/dev.js')) {
            build();
        } else {
            console.log(chalk.red.bold('☠️  Project dev failed:') + ' ' + chalk.blue('can\'t find src/scripts/config/env/dev.js file ☠️'));
            return console.log('');
        }
    ...
    function build() {
        ...
        var _concat = ' && ';
        var _createConfig = 'cp ' + _assetPathName + '/scripts/config/env/dev.js ' + _assetPathName + '/scripts/config/config.js';
